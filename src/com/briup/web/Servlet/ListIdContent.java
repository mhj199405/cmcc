...
/**
 * Servlet implementation class ListIdContent
 */
@WebServlet("/ListIdContent")
public class ListIdContent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
         ...
         request.getRequestDispatcher("user/main/updanotif.jsp").forward(request, response);
