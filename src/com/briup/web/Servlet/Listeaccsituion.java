...
@WebServlet("/Listeaccsituion")
public class Listeaccsituion extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				//3.查询数据库，得到总共有多少条记录
				total=UserSituationServiceImpl.getCountComp();
				...
				lists1=UserSituationServiceImpl.getPageShowCop(pageIndex, pageItems);
