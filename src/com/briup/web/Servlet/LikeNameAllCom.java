...
import com.briup.common.util.LikeAllCom;
@WebServlet("/LikeNameAllCom")
public class LikeNameAllCom extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		      ...
		      String name="%"+name1+"%";
				...
				total=LikeAllCom.getLikeCount(name);
				//3.查询数据库，得到总共有多少条记录
				//4.通过总的记录数计算出有多少页
				...
				lists=LikeAllCom.likecom(name, pageIndex, pageItems);
