...
/**
 * Servlet implementation class AdmListMyinfo
 */
@WebServlet("/AdmListMyinfo")
public class AdmListMyinfo extends HttpServlet {
		...
		// TODO Auto-generated method stub
		 ...
		 UserComplaintServiceImpl ucsi=new UserComplaintServiceImpl();
		  try {
			...
			request.getRequestDispatcher("/user/main/detailuseradm.jsp").forward(request, response);
		} catch (Exception e) {
