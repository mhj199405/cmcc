...
/**
 * Servlet implementation class TeaNotice
 */
@WebServlet("/TeaNotice")
public class TeaNotice extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//2.判断当前页是否到达第一页之前，如果到了，还是认为第一页
		   ...
		   total=Notclassification.getcoun(type);
			...
			request.getRequestDispatcher("user/main/st.jsp").forward(request, response);
	}
