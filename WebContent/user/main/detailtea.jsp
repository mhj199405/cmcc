			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form  class="form">
						...
						<div class="form-group">
							<label for="">被投诉者</label>
							<input type="text" name="name" class="form-control" value="${requestScope.list2.complaint}" readonly="readonly">
						</div>
						<div class="form-group">
							<label for="">处理单位</label>
							<input type="text" name="complaint" class="form-control"  value="${requestScope.list2.publish}" readonly="readonly">
						</div>
						<div class="form-group">
							<label for="">事件证据</label>
							<div class="text">
								<div class="summernote" name="content">${requestScope.list2.content}</div>
							</div>
						</div>
	...
	<script type="text/javascript">
  	$(function(){
		...
		$('.backDiv').click(function(){
			$('button[type=reset]').trigger('click');
			window.location.href="Browse?pageIndex=1&pageIndex1=1&comname=${sessionScope.user.username}";
		});
	})
