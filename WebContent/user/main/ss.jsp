...
<body>
	        ...
	        <div class="table-responsive"  style="border-color: #00b895;">
	         <div class="col-sm-6">
					    <div class="input-group col-sm-4">
					      <input type="text" class="form-control"  name="name" value="公告如下  :" style="height:28px;" readonly="readonly">
					      <span class="input-group-btn">
					        <button class="btn btn-default" type="submit" ><i class="fa fa-hand-o-right"></i></button>
					      </span>
					    </div>
		  		 </div>
	  			...
	  			<div class="col-sm-6">
	  				<div class=" btn-group col-sm-2.5 pull-right">
			            ...
			            <button type="button" class="btn btn-outline btn-default batchDel">
			                <i class="fa fa-weixin" onclick='getRequest()'></i>
			            </button>
	  				</div>
	        	</div>
	                ...
	                <c:forEach items="${users}" var="user">
	                    <tr>
	                        ...
	                        <td style="color:#337ab7">
	                        	<a href="ListstuIdConent?id=${user.id}"><i class="fa fa-file" style="cursor:pointer;margin-left:20px " ></i></a>
	                        </td>
	                    </tr>
	                 </c:forEach>
	                </tbody>
	...
	<script type="text/javascript">
  	 function goBack(){
  		 window.location.href="user/main/stutable.jsp";
  	 }
  	function reFreshs(){
  	  	//此处填写要处理的逻辑代码
  	  	    window.location.href="StuNotice?pageIndex=1&type=${requestScope.type}";//刷新
  	  	} 
  	function getRequest(){
  		window.location.href="https://login.weixin.qq.com/faq_webwxM";
  	}
    </script>
</body>
</html>