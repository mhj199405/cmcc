...
<body>
	...
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
                ...
                <li><a href="user/main/teamain.jsp">首页<span class="jt_down"></span></a>|</li>
    ...
    <div class="header3">
        <div class="h3_right">
             ...
             <div class="myyy">
            	<a href="Listeaccsituion?param=${ucpname}" target="_parent" style="color:#a296a2">${stt.accsituation}</a>
            	<!-- <a >受理详情</a> -->
                <span class="sj_down"></span>
             </div>
             <div class="tsc">
