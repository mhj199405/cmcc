        ...
        $().ready(function()
            {
                ...
                $(".one").on('click',function(){
                    window.location.href = "TeaNotice?pageIndex=1&type="+校级公告;
                });
                $(".two").on('click',function(){
                    window.location.href = "TeaNotice?pageIndex=1&type="+院级公告;
                });
                $(".three").on('click',function(){
                    window.location.href = "TeaNotice?pageIndex=1&type="+班级公告;
                });
           })
     </script>
    <div class="wrapper">
        ...
        <div class="content">
            <ul>
               <a href="TeaNotice?pageIndex=1&type=校级公告"><li class="one">校级公告</li></a>
                 <a href="TeaNotice?pageIndex=1&type=院级公告"><li class="two">院级公告</li></a>
                 <a href="TeaNotice?pageIndex=1&type=班级公告"><li class="three">班级公告</li></a>
            </ul>
        </div>
        <div class="bottom">
