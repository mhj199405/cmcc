...
<body>
	                ...
	                <c:forEach items="${users}" var="user">
	                    <tr>
	                        ...
	                        <td style="color:#337ab7">
	                        	...
	                        	&nbsp;&nbsp;<a style="color:red;"><i class="fa fa-trash-o" style="cursor:pointer;" onclick='dele(${user.username})'></i></a>
	                        </td>
	                    </tr>
	                 </c:forEach>
	                </tbody>
	...
	<script type="text/javascript">
  	 function goBack(){
  		 window.location.href="Student?pageIndex=1";
  	 }
  	function reFreshs(){
  	  	//此处填写要处理的逻辑代码
  	  	    window.location.href="Student?pageIndex=1";//刷新
  	  	} 
	  function dele(ids){
